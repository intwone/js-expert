	...
	describe('Pagination', () => {
		...
		describe('handleRequest', () => {
			it('should retry an request twice before throing an exception and validate request params and flow', async () => {
				...
				/**
				 * O spy retorna a quantidade de vezes que o método foi executado, ou seja, ele observará um função
				 */
				...
				const firsCallRetries = firstCallArg.retries

				assert.deepStrictEqual(firsCallRetries, expectedCallCount)
			...
			it('should return data from request when successed', async () => {
		...
		describe('getPaginated', () => {
			...
			it('should stop requesting when request return an ampty array', async () => {
